...
└── api/
    └── src/
        ...
        ├── lib/
        │   ├── controllers/         # Route handlers organised by service
        │   │   ├── accounts/        # accounts, funding, transactions
        │   │   ├── orders/          # orders, tracking, returns
        │   │   ├── products/        # products, categories, inventory, reviews
        │   │   └── users/           # auth, profile, admin
        │   ├── middleware/          # logger, 404 handler
        │   ├── routes/              # Subrouter definitions
        │   │   ├── accounts/
        │   │   ├── orders/
        │   │   ├── products/
        │   │   └── users/
...
```bash
git clone https://github.com/YOUR_USERNAME/Backend-Development-2026.git
